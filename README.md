...
<p align="center">Dragon Userbot 🔥 </p>
...
<p align="center"><a href="https://t.me/ANDRO_DEZINE"><img src="https://telegra.ph/file/dada6fbcbb38a89a944b3.jpg" width="300"></a></p>
<p align="center">
...
- Click on save button there at bottom to save your logs and forward it to us on [@YAAR_KAMEENE](https://t.me/YAAR_KAMEENE) if you face any problem
...
<p align="center"><a href="https://railway.app/new/template?template=https://github.com/RACHIT-KUSHWAHA/Railway-Deploy&envs=STRING_SESSION5,STRING_SESSION4,STRING_SESSION3,STRING_SESSION2,STRING_SESSION1,DATABASE_URL,API_ID,API_HASH,SUDO_USERS,MONGO_DB"> <img src="https://img.shields.io/badge/Deploy%20To%20Railway-black?style=for-the-badge&logo=railway" width="220" height="38.45"/></a></p>

## VPS/Locally deploy!
```console
DRAGON@Debian~ $ apt-get -y update
DRAGON@Debian~ $ apt-get -y install git gcc python3-dev
DRAGON@Debian~ $ git clone https://github.com/ITZ-ZAID/ZAID-USERBOT
DRAGON@Debian~ $ cd ZAID-USERBOT
DRAGON@Debian~ $ pip3 install -U-r requirements.txt
DRAGON@Debian~ $ cp sample.env .env
```
...
```console
DRAGON@Debian~ $ screen
DRAGON@Debian~ $ python3 main.py
```
...
<p align="center"><a href="https://t.me/YAAR_KAMEENE"><img src="https://img.shields.io/badge/ᴛᴇʟᴇɢʀᴀᴍ-𝐒𝐮𝐩𝐩𝐨𝐫𝐭-black?&style=for-the-badge&logo=telegram" width="220" height="38.45"></a></p>
<p align="center"><a href="https://t.me/ANDRO_DEZINE"><img src="https://img.shields.io/badge/ᴛᴇʟᴇɢʀᴀᴍ-𝐔𝐩𝐝𝐚𝐭𝐞𝐬-black?&style=for-the-badge&logo=telegram" width="220" height="38.45"></a></p>
